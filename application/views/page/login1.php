...
<html lang="en">
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						<div class="img" style="background-image: url(<?php echo base_url();?>assets/login1/images/bg-1.jpg);"></div>
  ...
  <script src="<?php echo base_url();?>assets/login1/js/popper.js"></script>
