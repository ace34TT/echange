          ...
          <div class="col-md-12">
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                <h3 class="text-uppercase">Login to <strong>Takalo</strong> </h3>
              ...
              <form action="<?php echo base_url('main/login');?>" method="post">
                ...
                <div class="form-group last mb-3">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="Your Password" id="password" value='<?php if(isset($password))  echo $password; ?>' required>
                </div>
