            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">Takalo <br></h1>
                           <p class="banner_text">Echanger vos objets que vous n'utiliser plus par des objets que vous souhaiter avoir</p>
                           <div class="read_bt"><a href="#">commencer</a></div>
                        </div>
                        <div class="col-sm-6">
                           <div class="banner_img"><img src="images/font.jpg"></div>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <p class="product_text">voici des listes d'echanges pour echanger vos objets</p>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        <h4 class="bursh_text">Anaran</h4>
                        <p class="lorem_text">description </p>
                        <img src="images/banner-bg.png" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
