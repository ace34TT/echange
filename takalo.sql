...
join objet o1 on o1.id_objet = e.id_objet1 join user u1 on u1.id=o1.id_owner
join objet o2 on o2.id_objet = e.id_objet2 join user u2 on u2.id=o2.id_owner
);
-- select u.name from user u join objet o on o.id_owner = u.id join echange e on e.id_objet2 = o.id_objet